...
<TopHeader/>
  {/* menu bar for mobile */}
    ...
    <div className="sm:flex sm:flex-col bg-white">
     ...
     {/* menu bar for mobile */}
     {!isMenuOpen &&
     <div onClick={() => toggleMenu()} className="w-6 h-6 md:hidden mt-[16px] ml-[16px] "><FaBars className="w-[18.75px] h-[14.25px] mt-[4.88px] ml-[2.63px]"/></div>
     }
          ...
          <ul className="flex gap-[24px]  items-center hidden sm:inline-flex">
            <div onClick={() => setCategory(!category)} className="flex gap-[4px] items-center">
 ...
 {isMenuOpen &&
                ...
                <div className="flex gap-4 items-center">
                 <Link href={"/casual"}><div className="font-satoshimedium text-sm border-r-[1px] border-black px-2">Casual</div></Link>
                 <Link href={"/formal"}><div className="font-satoshimedium text-sm border-r-[1px] border-black px-2">Formal</div></Link>
                 <Link href={"/fashion"}><div className="font-satoshimedium text-sm border-r-[1px] border-black px-2">Fashion</div></Link>
                 <Link href={"/gym"}> <div className="font-satoshimedium text-sm border-r-[1px] border-black px-2">Gym</div></Link>

                </div> 
}
                        <li className="font-satoshiregular text-[16px] leading-[21.6px]  ">On Sale</li>
                        <Link href={"/newarrivals"}><li className="font-satoshiregular text-[16px] leading-[21.6px]  ">New Arrivals</li></Link>
                        <li className="font-satoshiregular text-[16px] leading-[21.6px]  ">Brands</li>
                        </ul>
                    </div>
                     <div onClick={() => toggleMenu()} className="bg-white w-[50px] h-[20px] rounded-full z-30 ">
                                       <div className=" text-sm"><FaTimes className="w-5 h-5"/></div>
                                </div>
                   </div>     
             }
