...
const Footer = () => {
  ...
  {/* <div  className="absolute md:w-[1040px] md:top-[-90px] top-[90px]">
    ...
    <div className='w-full  md:static bg-black bg-opacity-[10%] md:mt-[1870px] mt-[1900px] h-[100%]  pt-[100px] md:pl-[50px] pl-4 pb-20 '>
       <div className="flex md:flex-row flex-col md:gap-[100px] gap-4 w-full h-auto md:mt-7 mt-0">
        ...
        {/* links grid*/}
        <div className="grid md:grid-cols-4 grid-cols-2 md:w-[744px] w-full md:gap-[248px] gap-3">
          {footerData.map((f) => (
       ...
       <div className="md:w-[1050px] w-[320px]  border-[1px] border-black border-opacity-[10%] mt-[60px]"></div>
       <div className="w-[1050px]  md:flex-row flex flex-col justify-between mt-6 ml-8 md:ml-0">
