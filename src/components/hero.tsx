...
<div className="flex flex-col sm:mt-0  sm:flex-row bg-[#f2f0f1] w-full justify-between h-[100vh] overflow-hidden ">
  {/* left */}
  <div className="md:max-w-[560px] sm:max-w-[315px] flex flex-col sm:ml-[100px] ml-[16px] mt-[30px] sm:mt-[120px] sm:gap-8 gap-6">
  ...
  <div className="absolute left-[1340px] w-[104px] top-[220px] h-[104px] hidden sm:inline-flex">
    <Image src={"/images/star.png"} alt="star" width={104} height={104} className="hidden sm:inline-flex"></Image>
  </div>
  <div className="absolute left-[850px] w-[56px] top-[470px] h-[56px] hidden sm:inline-flex">
