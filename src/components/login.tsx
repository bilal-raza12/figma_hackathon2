        ...
        <div className="max-w-md w-full">
          ...
          <SignedOut>
            ...
            <form className="mt-8 space-y-4">
              ...
              <div className="!mt-8">
                <div  className="w-full text-center py-3 px-4 text-sm tracking-wide rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
           ...
           <UserButton />
                ...
                <div className='text-2xl font-integralcfbold'>WELCOME to SHOP.CO!</div>
                <Link href={"/"}><button className='bg-black text-white px-6 py-4 rounded-[62px] mt-5'>Go to main page</button></Link>
                </SignedIn>
            </div>
          </div>
        </div>
