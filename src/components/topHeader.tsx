  ...
  return (
    <div className="w-full h-[38px] bg-black flex items-center justify-between">
      ...
      <div className=" mx-auto  bg-black text-white  ">
        <div className="font-satoshiregular sm:text-[14px] text-[12px] sm:leading-[18.9px] leading-[16.2px]">Sign up and get 20% off to your first order. <span className="underline font-satoshimedium"><Link href={"/login"}>Sign Up Now</Link></span></div>      
      </div>
